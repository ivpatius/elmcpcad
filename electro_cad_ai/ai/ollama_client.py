...
class OllamaClient:
    ...
    async def generate_text(self,
        ...
        try:
            ...
            return {"error": f"Не удалось подключиться к Ollama по адресу {self.base_url}. Убедитесь, что Ollama запущен (ollama serve)"}
    ...
    async def analyze_image(self,
        ...
        try:
            ...
            return {"error": f"Не удалось прочитать изображение: {e}"}
        ...
        try:
            ...
            return {"error": f"Не удалось подключиться к Ollama по адресу {self.base_url}"}
        except Exception as e:
            return {"error": f"Ошибка запроса: {str(e)}"}
